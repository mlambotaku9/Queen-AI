...
module.exports = {
      ...
      SESSION_ID: process.env.SESSION_ID || "QUEEN-AI;;;StartingBrakes", //enter your session id here
      OWNER_NUMBER: process.env.OWNER_NUMBER || "263714406565", //Owner whatsapp number here
